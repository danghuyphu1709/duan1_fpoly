...
class category extends BaseModel {
    ...
    public function postCategory($code,$name,$create_at,$create_by){
        $sql = "INSERT INTO ".$this->table." (`code`, `name`, `create_at`, `create_by`) 
                  VALUES (?,?,?,?)";
        $this->setQuery($sql);
        return $this->execute([$code,$name,$create_at,$create_by]);
    }
    public function putCategory($name,$update_at,$update_by,$deleted,$id){
    ...
    public function deletedCategory($key,$id){
